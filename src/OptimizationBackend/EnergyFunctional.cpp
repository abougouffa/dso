...
void EnergyFunctional::accumulateAF_MT(MatXX& H, VecX& b, bool MT) {
  if (MT) {
    ...
    red->reduce(boost::bind(&AccumulatedTopHessianSSE::addPointsInternal<0>,
                            accSSE_top_A, &allPoints, this, boost::placeholders::_1, boost::placeholders::_2, boost::placeholders::_3, boost::placeholders::_4),
                0, allPoints.size(), 50);
...
void EnergyFunctional::accumulateLF_MT(MatXX& H, VecX& b, bool MT) {
  if (MT) {
    ...
    red->reduce(boost::bind(&AccumulatedTopHessianSSE::addPointsInternal<1>,
                            accSSE_top_L, &allPoints, this, boost::placeholders::_1, boost::placeholders::_2, boost::placeholders::_3, boost::placeholders::_4),
                0, allPoints.size(), 50);
...
void EnergyFunctional::accumulateSCF_MT(MatXX& H, VecX& b, bool MT) {
  if (MT) {
    ...
    red->reduce(boost::bind(&AccumulatedSCHessianSSE::addPointsInternal,
                            accSSE_bot, &allPoints, true, boost::placeholders::_1, boost::placeholders::_2, boost::placeholders::_3, boost::placeholders::_4),
                0, allPoints.size(), 50);
...
void EnergyFunctional::resubstituteF_MT(VecX x, CalibHessian* HCalib, bool MT) {
  ...
  if (MT)
    red->reduce(boost::bind(&EnergyFunctional::resubstituteFPt,
                            this, cstep, xAd, boost::placeholders::_1, boost::placeholders::_2, boost::placeholders::_3, boost::placeholders::_4),
                0, allPoints.size(), 50);
  else
